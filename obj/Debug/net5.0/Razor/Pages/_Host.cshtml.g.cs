#pragma checksum "E:\home\development\blazer\OWFBlazorDemo\Pages\_Host.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8ba6720b820ba8e7b94797b8fd308dad53ce176d"
// <auto-generated/>
...
namespace OWFBlazorDemo.Pages
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8ba6720b820ba8e7b94797b8fd308dad53ce176d", @"/Pages/_Host.cshtml")]
...
#nullable disable
            WriteLiteral("\r\n<!DOCTYPE html>\r\n<html lang=\"en\">\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8ba6720b820ba8e7b94797b8fd308dad53ce176d4361", async() => {
                WriteLiteral(@"
    <meta charset=""utf-8"" />
    ...
    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("base", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "8ba6720b820ba8e7b94797b8fd308dad53ce176d5126", async() => {
                }
                );
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8ba6720b820ba8e7b94797b8fd308dad53ce176d7254", async() => {
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("component", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "8ba6720b820ba8e7b94797b8fd308dad53ce176d7516", async() => {
                }
                );
...
#nullable disable
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("environment", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8ba6720b820ba8e7b94797b8fd308dad53ce176d9520", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("environment", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8ba6720b820ba8e7b94797b8fd308dad53ce176d10877", async() => {
    ...
    <script>
        ...
        */
        class OWFInterface {
        ");
                WriteLiteral(@"    constructor(dotnetInterface) {
                this.dotnetInterface = dotnetInterface;

                this.shared = dotnetInterface.shared;
                this.jsUtilities = dotnetInterface.jsUtilities;
                this.owfInterface = dotnetInterface.owfInterface;
            };
            ...
            onGetUserUUIDSuccess = function (pref) {
                ...
                if (pref.value) {
                    ...
                    self.dotnetInterface.notifyDotnet(""owf.user.uuid"", self.shared.userProfile.uuid);
             ");
                WriteLiteral(@"   } else {
            ...
            onGetUserUUIDFailure = function (error, status) {
                ...
                WriteLiteral(@"0);
                    ...
                    self.dotnetInterface.notifyDotnet(""owf.user.uuid"", ""!ERROR! - cannot retrieve user profile info/"" + status + ""/"" + error);
                }
            };
     ...
     ");
                WriteLiteral(@"           self.dotnetInterface.notifyDotnet(""owf.user"", JSON.stringify(userInfo));
            };
            ...
            onGetUserInfoFailure = function (error, status) {
                ...
                self.dotnetInterface.notifyDotnet(""owf.user"", ""!ERROR! - cannot retrieve user profile info/"" + status + ""/"" + error);
            };
            ...
            GetUserGroups = function() {
                ...
                self.shared.jsUtilities.ajaxCall(self.shared.owfInstance + ""owf/group?user_id="" + self.shared.userProfile.currentId,
                    null,
                    owfdojo.hitc");
                WriteLiteral(@"h(self, ""onGetGroupSuccess""),
                    null,
                    null,
                    ""application/json"",
                    ""GROUPINFO"");
            ...
            onGetGroupSuccess = function (groups) {
                ...
                self.dotnetInterface.notifyDotnet(""owf.user.groups"", JSON.stringify(self.shared.userProfile.groups));
            };
            ...
            GetUserPreference = function (key) {
                ...
                OWF.Preferences.getUserPreference({
                    namespace: s");
                WriteLiteral(@"elf.shared.namespace,
                    name: key,
            ...
            onGetUserPreferenceSuccess = function (key, pref) {
                let self = this;
                self.dotnetInterface.notifyDotnet(""owf.preference.get"", JSON.stringify(pref));
            };

            onGetUserPreferenceFailure = function (key, error, status) {
                let self = this;
                self.dotnetInterface.notifyDotnet(""owf.preference.get"", ""!ERROR! - cannot get preference ("" + key + "")/"" + status + ""/"" + error);
            };
            ...
            SetUserPreference = function (key, value) {
                ...
                OWF.Preferences.setUserPreference({
                    ...
                    value: value,
   ");
                WriteLiteral(@"                 onSuccess: owfdojo.hitch(self, ""onSetUserPreferenceSuccess"", key, value),
            ...
            onSetUserPreferenceSuccess = function (key, value, payload) {
                let self = this;
                self.dotnetInterface.notifyDotnet(""owf.preference.set"", JSON.stringify(payload));
            };

            onSetUserPreferenceFailure = function (key, value, error, status) {
                let self = this;
                self.dotnetInterface.notifyDotnet(""owf.preference.set"", ""!ERROR! - cannot set preference ("" + key + "":"" + value + "")/"" + status + ""/"" + error);
            };
            ...
            DeleteUserPreference = function (key) {
                ...
                OWF.Preferences.deleteUserPreference({
                    namespace: self.shared.namespace,
                    name: key,
                    onSuccess: owfdojo.hitch(self");
                WriteLiteral(@", ""onDeleteUserPreferenceSuccess"", key),
            ...
            onDeleteUserPreferenceSuccess = function (key, payload) {
                let self = this;
                self.dotnetInterface.notifyDotnet(""owf.preference.delete"", JSON.stringify(payload));
            };

            onDeleteUserPreferenceFailure = function (key, error, status) {
                let self = this;
                self.dotnetInterface.notifyDotnet(""owf.preference.delete"", ""!ERROR! - cannot get preference ("" + key + "")/"" + status + ""/"" + error);
            };
        };
        ...
        */
        class CMAPIInterface {
            constructor(dotnetInterface) {
                this.dotnetInterface = dotnetInterface;

                this.shared = dotnetInterface.shared;
                this.jsUtilities = dotnetInterface.jsUtilities;
                this.owfInterface");
                WriteLiteral(@" = dotnetInterface.owfInterface;
            };
            ...
            ReceiveMapStatusView = function (sender, message) {
                ...
                self.dotnetInterface.notifyDotnet(""map.status.view"", message);
            };
            ...
            ReceiveMapViewClicked = function (sender, message) {
                ...
                self.dotnetInterface.notifyDotnet(""map.view.clicked"", message);
            };
        };
   ...
   ");
                WriteLiteral(@"             dotnetInstance: null,
                channels: {},
                userProfile: {
                    uuid: """",
                    currentUserName: """",
            ...
            constructor() {
                ...
                this.shared.dotnetInterface = this;
            };
            ...
            notifyDotnet = function(channel, message) {
                ...
                if (self.shared.hasOwnProperty(""dotnetInstance"") && self.shared.dotnetInstance &&
                    ...
                    let callback = self.shared.channels[channel].call");
                WriteLiteral(@"back;
            ...
            */
            ...
            shutdownWidget = function() {
                ...
                self._WidgetStateController.removeStateEventOverride");
                WriteLiteral(@"s({
                    events: ['beforeclose'],
                    callback: function () {
            ...
            */
            ...
            AttachHandlers = () => {
                ...
                */
         ");
                WriteLiteral("   };\r\n        };\r\n\r\n        var dotnetInterface = new DOTNETInterface();\r\n        Blazor.start();\r\n    </script>\r\n");
            }
            );
