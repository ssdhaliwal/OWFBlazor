#pragma checksum "E:\home\development\blazer\OWFBlazorDemo\Pages\_Host.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e26c109e63913fe902090306b4b929b8f6d80425"
// <auto-generated/>
...
namespace OWFBlazorDemo.Pages
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e26c109e63913fe902090306b4b929b8f6d80425", @"/Pages/_Host.cshtml")]
...
#nullable disable
            WriteLiteral("\r\n<!DOCTYPE html>\r\n<html lang=\"en\">\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e26c109e63913fe902090306b4b929b8f6d804254361", async() => {
                WriteLiteral(@"
    <meta charset=""utf-8"" />
    ...
    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("base", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "e26c109e63913fe902090306b4b929b8f6d804255126", async() => {
                }
                );
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e26c109e63913fe902090306b4b929b8f6d804257254", async() => {
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("component", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "e26c109e63913fe902090306b4b929b8f6d804257516", async() => {
                }
                );
...
#nullable disable
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("environment", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e26c109e63913fe902090306b4b929b8f6d804259520", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("environment", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e26c109e63913fe902090306b4b929b8f6d8042510877", async() => {
    ...
    <script>
        ...
        retrieveUserConfig = function (key) {
        ...
        onGetUserConfigSuccess = function (pref) {
            self._objects.uuid = JSON.parse(pref.value);
        };

        onGetUserConfigFailure = function (error, status) {
            console.log(""!ERROR! - cannot retrieve user configuration/"" + status + ""/"" + error);
            self._obje");
                WriteLiteral(@"cts.uuid = ""{error}"";
        };
        ...
        onSetUserConfigFailure = function (error, status) {
            console.log(""!ERROR! - cannot retrieve user configuration/"" + status + ""/"" + error);
        };
        ...
        receiveMapStatusView = function (sender, message) {
                ...
                // store");
                WriteLiteral(@" the map zoom level
                if (self._objects.hasOwnProperty(""dotnetInstance"") && self._objects.dotnetInstance &&
                    (self._objects.channels.indexOf(""map.status.view"") >= 0)) {
                    const result = self._objects.dotnetInstance.invokeMethodAsync('GetMapStatusView', message);
                }
        };
        ...
        window.NotificationManager = {
            ...
            start: (channel) => {
                let index = self._objects.channels.indexOf(channel);
                if (index < 0) {
                    self._objects.channels.push(channel);
                }
            },
            stop: (channel) => {
                let index = self._objects.channels.indexOf(channel);
                if (index >= 0) {
                    self._objects.channels.splice(index);
                }
            },
            deregister: () => {
                self._obj");
                WriteLiteral(@"ects.channels = [];
