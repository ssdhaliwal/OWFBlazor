#pragma checksum "E:\home\development\blazer\OWFBlazorDemo\Pages\_Host.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b6657b71a5da0e93312f8d4a12b7321253b589b5"
// <auto-generated/>
...
namespace OWFBlazorDemo.Pages
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b6657b71a5da0e93312f8d4a12b7321253b589b5", @"/Pages/_Host.cshtml")]
...
#nullable disable
            WriteLiteral("\r\n<!DOCTYPE html>\r\n<html lang=\"en\">\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b6657b71a5da0e93312f8d4a12b7321253b589b54361", async() => {
                WriteLiteral(@"
    <meta charset=""utf-8"" />
    ...
    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("base", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "b6657b71a5da0e93312f8d4a12b7321253b589b55126", async() => {
                }
                );
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b6657b71a5da0e93312f8d4a12b7321253b589b57254", async() => {
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("component", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "b6657b71a5da0e93312f8d4a12b7321253b589b57516", async() => {
                }
                );
...
#nullable disable
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("environment", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b6657b71a5da0e93312f8d4a12b7321253b589b59520", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("environment", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b6657b71a5da0e93312f8d4a12b7321253b589b510877", async() => {
        ...
        ");
            ...
            onGetUserUUIDSuccess = function (pref) {
                ...
                if (pref.value) {
                    ...
                    self.interopInterface.notifyDotnet(""owf.user.uuid"", self.shared.userProfile.");
                WriteLiteral(@"uuid);
                } else {
            ...
            onGetUserUUIDFailure = function (error, status) {
                ...
                if (status !== 404) {
                    window.setTimeout(function() {
                        ...
                        self.SetUserPreference(""uuid"", self.share");
                WriteLiteral(@"d.userProfile.uuid);
                    }, 500);
                } else {
            ...
            onGetUserInfoSuccess = function (userInfo) {
                ...
                self.sha");
                WriteLiteral(@"red.userProfile.email = userInfo.email;
        ...
        */
        class CMAPIInterface {
            constructor(interopInterface) {
                ...
                this.shared = interopInterface.shared;
                this.jsUtilities = in");
                WriteLiteral(@"teropInterface.shared.jsUtilities;
                this.owfInterface = interopInterface.shared.owfInterface;
            };
            ...
            PlotMarker = function (overlay, title, uuid, coordinates) {
                // for");
                WriteLiteral(@"mat kml and cmapi message for marker and publish it
                let payload = {
                    overlayId:overlay,
            ...
            PlotLineString = function (overlay, title, uuid, coordinates, style) {
                ...
                WriteLiteral(@"Id:overlay,
                    ...
                    feature:""<?xml version=\""1.0\"" encoding=\""UTF-8\""?>\n"" +
                        ...
                        ""<Document>\n"" +
                        ""    <name>"" + overla");
                WriteLiteral(@"y.replace(/ /g, ""-"") + ""_"" + title.replace(/ /g, ""-"") + "".kml</name>\n\n"" +
                        ""    <Style id=\""redline\"">\n"" +
                        ...
                        ""        <LineString>\n"" +
                     ");
                WriteLiteral(@"   ""            <coordinates>"" + coordinates + ""</coordinates>\n"" +
                        ""        </LineString>\n\n"" +
                        ""    </Placemark>\n\n"" +
                        ""</Document>\n"" +
                        ""</kml>""
            ...
            PlotPolygon = function (overlay, title, uuid, outerBoundary, innerBoundary, style) {
                ...
                WriteLiteral(@"pacity:0.8,
                    ...
                    feature:""<?xml version=\""1.0\"" encoding=\""UTF-8\""?>\n"" +
                        ...
                        ""    </Style>\n"" +
                        ""    <Style id=\""blueline\"">\n"" +
                        ""        <LineStyle><color>07659300</color><width>4</");
                WriteLiteral(@"width> </LineStyle>\n"" +
                        ""    </Style>\n"" +
                        ""    <Style id=\""greenline\"">\n"" +
                        ""        <LineStyle><color>07930955</color><width>6</width> </LineStyle>\n"" +
                        ""    </Style>\n\n"" +
   ...
   ");
            ...
            PlotJSONPolygon = function (overlay, title, uuid, outerBoundary, innerBoundary, color) {
                ...
                let payload = {
                    overlayId:overlay,
         ");
                WriteLiteral(@"           featureId:title.replace(/ /g, ""-""),
                    name:title,
                    format:""jsonobject"",
                    params:{
                        zoom:""false"",
                ...
                OWF.Eventing.publish(""map.feature.plot"", JS");
                WriteLiteral(@"ON.stringify(payload));
            };
        ...
        */
        class INTEROPInterface {
            ...
            INTEROPMessageHandler = {
                ...
                stop: (channel) => {
                    let self = this;
                    let valid = self.share");
                WriteLiteral(@"d.channels.hasOwnProperty(channel);
                    if (valid) {
            ...
            */
            ...
            shutdownWidget = function() {
                // remove listener overr");
                WriteLiteral(@"ide to prevent looping
            ...
            */
            ...
            AttachHandlers = () => {
                console.log("".. attaching handlers! (deb");
                WriteLiteral(@"ug view trap; remove prior to publish for production)"");
